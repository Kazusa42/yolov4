...
def draw_plot_func(dictionary, n_classes, window_title, plot_title, x_label, output_path,
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            for idx, detection in enumerate(dr_data):
                ...
                if show_animation:
                    ...
                    img, line_width = draw_text_in_image(img, text,
                                                         (margin + line_width, v_pos), light_blue, line_width)
                    if ovmax != -1:
                        color = light_red
            ...
            if len(prec) > 0:
                print(text + "\t||\tscore_threhold=0.5 : " + "F1=" + "{0:.2f}".format(F1[score05_idx]) +
                      " ; Recall=" + "{0:.2f}%".format(rec[score05_idx] * 100) + " ; Precision=" +
...
def preprocess_gt(gt_path, class_names):
    ...
    for i, cls in enumerate(class_names):
        category = {'supercategory': cls, 'name': cls, 'id': i}
